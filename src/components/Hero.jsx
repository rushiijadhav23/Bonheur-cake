...
const Hero = () => {
  return (
    <div className="w-full min-h-screen relative bg-[#fff5f7]">
      <div className="max-w-7xl mx-auto pt-24 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            <img 
              src="https://images.unsplash.com/photo-1488477304112-4944851de03d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80"
              alt="Delicious Cake"
